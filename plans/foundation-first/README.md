...
- G7: `ms-gym-plans` implements domain, persistence, Spring HTTP public routes (proto JSON via `common-java:2.0.1`), and mTLS gRPC; `gym-infra` Java CI/Docker wired. Helm values/render and full G7 closeout evidence still open.
